...
def lowercase_letter_strokes():
    return {
        'a': [
            circle_arc(0.42, 0.62, 0.22, -pi/2, 3*pi/2),
            line_pts((0.64, 0.40), (0.64, 0.85)),
        ],
        'b': [
            line_pts((0.2, 0.05), (0.2, 0.85)),
            elliptic_arc(0.2, 0.62, 0.52, 0.23, -pi/2, pi/2),
        ],
        'c': [
            circle_arc(0.5, 0.62, 0.24, -pi/3, -5*pi/3),
        ],
        'd': [
            circle_arc(0.42, 0.62, 0.22, -pi/2, 3*pi/2),
            line_pts((0.64, 0.05), (0.64, 0.85)),
        ],
        'e': [
            line_pts((0.26, 0.62), (0.74, 0.62)),
            circle_arc(0.5, 0.62, 0.24, 0, -5*pi/3),
        ],
        'f': [
            (curve_through((0.62, 0.12), (0.30, 0.04), (0.40, 0.28)) +
             line_pts((0.40, 0.28), (0.40, 0.85), 6)[1:]),
            line_pts((0.20, 0.40), (0.62, 0.40)),
        ],
        'g': [
            circle_arc(0.42, 0.62, 0.22, -pi/2, 3*pi/2),
            (line_pts((0.64, 0.40), (0.64, 0.88), 6) +
             curve_through((0.64, 0.88), (0.50, 0.99), (0.25, 0.93))[1:]),
        ],
        'h': [
            line_pts((0.2, 0.05), (0.2, 0.85)),
            (curve_through((0.20, 0.50), (0.50, 0.38), (0.78, 0.50)) +
             line_pts((0.78, 0.50), (0.78, 0.85), 5)[1:]),
        ],
        'i': [
            line_pts((0.5, 0.40), (0.5, 0.85)),
            line_pts((0.44, 0.18), (0.56, 0.22), 3),
        ],
        'j': [
            (line_pts((0.55, 0.40), (0.55, 0.88), 5) +
             curve_through((0.55, 0.88), (0.40, 0.98), (0.25, 0.90))[1:]),
            line_pts((0.49, 0.18), (0.61, 0.22), 3),
        ],
        'k': [
            line_pts((0.2, 0.05), (0.2, 0.85)),
            line_pts((0.75, 0.40), (0.2, 0.62)),
            line_pts((0.2, 0.62), (0.75, 0.85)),
        ],
        'l': [
            line_pts((0.5, 0.05), (0.5, 0.85)),
        ],
        'm': [
            line_pts((0.10, 0.40), (0.10, 0.85)),
            (curve_through((0.10, 0.50), (0.30, 0.38), (0.50, 0.50)) +
             line_pts((0.50, 0.50), (0.50, 0.85), 4)[1:]),
            (curve_through((0.50, 0.50), (0.70, 0.38), (0.90, 0.50)) +
             line_pts((0.90, 0.50), (0.90, 0.85), 4)[1:]),
        ],
        'n': [
            line_pts((0.2, 0.40), (0.2, 0.85)),
            (curve_through((0.20, 0.50), (0.50, 0.38), (0.78, 0.50)) +
             line_pts((0.78, 0.50), (0.78, 0.85), 5)[1:]),
        ],
        'o': [
            circle_arc(0.5, 0.62, 0.23, -pi/2, 3*pi/2),
        ],
        'p': [
            line_pts((0.2, 0.20), (0.2, 0.97)),
            elliptic_arc(0.2, 0.52, 0.52, 0.23, -pi/2, pi/2),
        ],
        'q': [
            circle_arc(0.42, 0.62, 0.22, -pi/2, 3*pi/2),
            line_pts((0.64, 0.40), (0.64, 0.97)),
        ],
        'r': [
            line_pts((0.25, 0.40), (0.25, 0.85)),
            curve_through((0.25, 0.48), (0.50, 0.38), (0.72, 0.45)),
        ],
        's': [
            (bezier_pts((0.72, 0.43), (0.12, 0.38), (0.50, 0.62)) +
             bezier_pts((0.50, 0.62), (0.88, 0.87), (0.28, 0.82))[1:]),
        ],
        't': [
            line_pts((0.5, 0.08), (0.5, 0.85)),
            line_pts((0.22, 0.35), (0.72, 0.35)),
        ],
        'u': [
            (line_pts((0.2, 0.40), (0.2, 0.70), 4) +
             curve_through((0.2, 0.70), (0.5, 0.88), (0.8, 0.70))[1:] +
             line_pts((0.8, 0.70), (0.8, 0.40), 4)[1:]),
        ],
        'v': [
            line_pts((0.15, 0.40), (0.5, 0.85)),
            line_pts((0.5, 0.85), (0.85, 0.40)),
        ],
        'w': [
            line_pts((0.08, 0.40), (0.30, 0.85)),
            line_pts((0.30, 0.85), (0.50, 0.55)),
            line_pts((0.50, 0.55), (0.70, 0.85)),
            line_pts((0.70, 0.85), (0.92, 0.40)),
        ],
        'x': [
            line_pts((0.15, 0.40), (0.85, 0.85)),
            line_pts((0.85, 0.40), (0.15, 0.85)),
        ],
        'y': [
            line_pts((0.15, 0.40), (0.55, 0.72)),
            (line_pts((0.82, 0.40), (0.55, 0.72), 4) +
             line_pts((0.55, 0.72), (0.55, 0.88), 3)[1:] +
             curve_through((0.55, 0.88), (0.40, 0.97), (0.22, 0.90))[1:]),
        ],
        'z': [
            line_pts((0.15, 0.40), (0.85, 0.40)),
            line_pts((0.85, 0.40), (0.15, 0.85)),
