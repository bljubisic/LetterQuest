...
---
*To use this as your live privacy policy: fill in the date and support email
above, then host this file's content somewhere with a stable URL (GitHub
Pages off this repo is a free, simple option) — App Store Connect requires a
live URL, not a file upload.*
